...
Public Class StockInReport
    ...
    Private Sub data()
        Dim query As String = "SELECT * FROM dbo.StockIn_Transactions WHERE Date BETWEEN @FromDate AND @ToDate"
        ...
        cmd = New SqlCommand("SELECT DISTINCT Category FROM dbo.StockIn_Transactions", con)
        sd = New SqlDataAdapter(cmd)
